      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('usuario') }}">Publicaciones</a></li>
            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
            <form action="{{ route('guardar.post') }}" id="form-general" class="form-horizontal form--label-right" method="POST" autocomplete="off" enctype="multipart/form-data">
                @csrf
                        <div class="card-body">
