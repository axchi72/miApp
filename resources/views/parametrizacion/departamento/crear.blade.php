      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('departamento') }}">Sistema de Departamentos</a></li>
        ...
        <div class="col-lg-12">
            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-tools">
                    <a href="{{ route('departamento') }}" class="btn btn-block btn-outline-primary">
            ...
            <form action="{{ route('guardar_departamento') }}" id="form-general" class="form-horizontal form--label-right" method="POST" autocomplete="off">
                @csrf
                        <div class="card-body">
                            @include('parametrizacion.departamento.form')
                        </div>
                        <!-- /.card-body -->
                    </div>
                </div>
