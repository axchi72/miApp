      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Editar Situación Laboral</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
            <form action="{{ route('actualizar_slaboral', ['id' => $data->id]) }}" id="form-general" class="form-horizontal form--label-right" method="POST" autocomplete="off">
                @csrf @method("put")
                        <div class="card-body">
