      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('cotiza') }}">Sistema de Cuentas</a></li>
            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
            <form action="{{ route('actualizar_cuenta', ['id' => $data->id]) }}" id="form-general" class="form-horizontal form--label-right" method="POST" autocomplete="off">
                @csrf @method("put")
                        <div class="card-body">
